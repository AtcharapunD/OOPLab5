        ...
        do {
            ...
            if (choice >= 1 && choice <= 3) {
                if (choice == 1) {
                    ...
                    JOptionPane.showMessageDialog(null, "Area circle is " + fourDigit.format(area(radius)), "Result",
                    ...
                    JOptionPane.showMessageDialog(null, "Area rectangle is " + fourDigit.format(area(width, height)),
